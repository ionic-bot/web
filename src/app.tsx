    ...
    <div class="min-w-screen min-h-screen bg-[#FEFBFE]">
        <nav class="flex flex-row items-center p-4 bg-white border-b border-[#EF8354]">
          ...
          <ul class="flex flex-row w-full space-x-4 text-xl items-center">
            ...
            <li class="!ml-auto"><A href="/dashboard" class="bg-[#3066BE] hover:bg-[#2957A3] active:bg-[#224886] text-white px-6 py-4 rounded-full" activeClass="bg-[#224886]">Dashboard</A></li>
          </ul>
        </nav>
        <div class="p-4">
          {props.children}
